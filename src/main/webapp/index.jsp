...
<%@ page import="com.betadesign.registration.ProductServlet" %>
<%@ page import="com.betadesign.registration.Product" %>
...
<body id="page-top">
	...
	<nav
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="addItem.jsp">Add Item</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="Dashboard.jsp">Users</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	 ...
	 <h2 class="toppy">Product List</h2>
    <div class="grid">
        <%
            ProductServlet productServlet = new ProductServlet();
            ArrayList<Product> products = productServlet.getProducts();
            for (Product product : products) {
        %>
        <div class="card">
            <h3><%= product.getName() %></h3>
            <p>Price: Ksh<%= product.getPrice() %></p>
